...
myOrders.then(orders => {
    ...
    orders.forEach(order => {
        ...
        // tdElemenet.innerHTML = date.getTime() ? date.toLocaleDateString() : 'Not Provided';
        tdElemenet.innerHTML = date.toLocaleDateString();
        trElement.appendChild(tdElemenet);
        trElement.appendChild(tdElemenet);
        tdElemenet = document.createElement('td');
...
function handleEvent(e) {
    ...
    let order = allOrders.find(order => order['order_id'] === id);
    ...
    try {
        ...
        divElem.textContent = 'Items are not provided';
    } finally {
...
function appendItemRow(table, item) {
    ...
    td.textContent = item.variety || 'Not Provided';
    tr.appendChild(td);
    td = document.createElement('td');
    td.textContent = item.winery || 'Not Provided';
    tr.appendChild(td);
    td = document.createElement('td');
